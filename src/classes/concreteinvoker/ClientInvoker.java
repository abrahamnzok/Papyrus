...
public class ClientInvoker extends Application implements Invoker {
   ...
   * @param position Position where to insert Invoke the Insert command.
   */
  ...
  /**
   * @param position Position of the character to delete Invoke the delete command.
   */
  ...
  /**
   * @param event the MouseEvent (on click on the button) Invoke the Undo command
   */
  @FXML
  private void handleUndo(MouseEvent event)
      throws NoSuchMethodException, CloneNotSupportedException {
  ...
  /**
   * @param event the MouseEvent (on click on the button) Invoke the Redo command.
   */
  @FXML
  private void handleRedo(MouseEvent event)
      throws NoSuchMethodException, CloneNotSupportedException {
  ...
  /**
   * @param event the MouseEvent (on click on the button) Invoke {@link Copy} command.
   */
  @FXML
  ...
  /**
   * @param event the MouseEvent (on click on the button) Invoke {@link Cut} command and mimic the
   * same effect on the UI.
   */
  @FXML
  private void handleCut(MouseEvent event)
      throws CloneNotSupportedException, NoSuchMethodException {
    this.setCommand(this.commandMap.get("cut"));
    this.textarea.setText(this.engine.getBufferClone().getText());
  }

  /**
   * @param event the MouseEvent (on click on the button) Invoke {@link Delete} command and mimic
   * the same effect on the UI.
   */
  @FXML
  ...
  /**
   * @param event the MouseEvent (on click on the button) Invoke {@link Paste} command and mimic the
   * same effect on the UI.
   */
  @FXML
  private void handlePaste(MouseEvent event)
      throws CloneNotSupportedException, NoSuchMethodException {
    ...
    this.textarea.setText(new StringBuilder(this.textarea.getText())
        .insert(caretPosition, this.engine.getClipboardClone().getClipboard()).toString());
  ...
  /**
   * @param event the ActionEvent (on click on the label) Invoke {@link Replay} command and mimic
  ...
  /**
   * @param event the ActionEvent (on click on the label) Invoke {@link Record} command and mimic
   * the same effect on the UI.
   */
  @FXML
  ...
  /**
   * @param event the ActionEvent (on click on the label) Invoke {@link Stop} command and mimic the
   * same effect on the UI.
   */
  @FXML
  ...
  /**
   * @param command to execute Execute the given {@link Command}
   */
