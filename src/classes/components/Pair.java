...
public class Pair<F, S> implements PairInterface, Cloneable {
  ...
  /**
   * Object of any type {@code int} {@code String} {@code Object} represents the key of the pair
   */
  private final F key;

  /**
   * Object of any type {@code int} {@code String} {@code Object} represents the value of the pair
   */
